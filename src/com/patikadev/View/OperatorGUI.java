...
public class OperatorGUI extends JFrame {
    ...
    public OperatorGUI(Operator operator) {
        ...
        tbl_user_list.getSelectionModel().addListSelectionListener(e -> {
            try {
                String selected_row = tbl_user_list.getValueAt(tbl_user_list.getSelectedRow(), 0).toString();
                fld_user_id.setText(selected_row);
            } catch (Exception ex) {
    ...
    public static void main(String[] args) {
        Helper.setLayout();
        OperatorGUI operatorGUI = new OperatorGUI(new Operator(1, "Mustafa Çetindağ", "mustafa", "1234", "Operator"));
